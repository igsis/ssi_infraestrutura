...
if(isset($_POST['carregar']))
{
	...
	$sql_user = "SELECT * FROM users WHERE id ='$users_id'";
			...
			<div class="col-md-offset-1 col-md-10">
				<form class="form-horizontal" role="form" action="?perfil=administrador&p=cadastra" method="post">
					...
					<div class="form-group">
						...
						<div class="col-md-2">
							<input type="submit" name="carregar" value="Carregar" class="btn btn-theme btn-md btn-block">
						</div>
					</div>
				</form>
				...
				<form class="form-horizontal" role="form" action="?perfil=administrador&p=detalhes" method="post">
					...
					<div class="form-group">
						<div class="col-md-offset-1 col-md-3"><strong>Telefone:</strong><br/>
							<input type="text" class="form-control" name="phone" id="telefone" onkeyup="mascara( this, mtel );" maxlength="15" value="<?php echo isset($userPhone) ? $userPhone : null; ?>">
						</div>
						<div class="col-md-4"><strong>E-mail:</strong><br/>
							<input type="text" class="form-control" name="email" maxlength="100" value="<?php echo isset($userEmail) ? $userEmail : null; ?>">
						</div>
						<div class="col-md-3"><strong>Contato:</strong><br/>
							<input type="text" class="form-control" name="contact" maxlength="20" value="<?php echo isset($userContact) ? $userContact : null; ?>">
						</div>
					</div>
					...
					<div class="form-group">
						<div class="col-md-offset-1 col-md-10"><strong>Solução</strong><br/>
							<textarea name="solution" class='form-control' cols="40" rows="6"></textarea>
						</div>
					</div>
